    ...
    return (
        <div className="flex flex-col items-center">
            <div className="relative">
                ...
                <span
                    className="absolute -bottom-2 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[var(--accent-cyan)] to-transparent opacity-50"
                />
            </div>
